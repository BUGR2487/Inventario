...
--
-- Host: localhost:8889
-- Generation Time: Nov 04, 2020 at 03:29 AM
...
(1, 'Carlos Gabriel', 'Luna', 'Montes', 'Desarrollador', 'carlosgabrieluna@gmail.com', 'carlosgabriel1'),
(2, 'a', 'a', 'a', 'a', 'a', 'a');
...
--
ALTER TABLE `entradas`
  MODIFY `IdEntradas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
